  ...
  <div class="container">
    ...
    <div class="login-container">
      ...
      <form class="login-form row" @submit.prevent="register">
        <div class="col-md-12 pb-3">Thông tin chung</div>
        <div class="col-md-12">
        ...
        <div class="col-md-12 pb-3">Thông tin Tài khoản Người đại diện</div>
        <div class="col-md-6">
          <div>
            <p>Họ và tên (*)</p>
            <div class="input-group">
...
// Create a single form data object for all fields
const formData = ref({
  // Company information
  companyName: '',
  shortName: '',
...
const register = async () => {
  ...
  const payload = {
    ...
    // Use identifier and password for authentication (assuming your API expects these fields)
    identifier: formData.value.email, // Using email as identifier
  }

  loading.value = true
  try {
    // You might need to create a register function in your authStore
    // For now, I'm using the login function that was in your original code
    await authStore.register(payload) // Replace with the appropriate API call
    await router.push('/') // Redirect after successful registration
  } catch (err) {
